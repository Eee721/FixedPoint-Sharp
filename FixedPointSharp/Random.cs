...
namespace com.muf.fixedmath
{
    ...
    public struct Random
    {
        ...
        public Fix64 NextFp()
        {
            return new Fix64(NextInt(0, 65535));
        }
        ...
        /// <summary>Returns value in range [min, max]</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Fix64 NextFp(Fix64 min, Fix64 max)
        {
        ...
        {
            var angle = NextFp() * Fix64.pi * Fix64._2;
        ...
        {
            var z = NextFp(Fix64._2) - Fix64._1;
            var r = fixmath.Sqrt(fixmath.Max(Fix64._1 - z * z, Fix64._0));
            var angle = NextFp(Fix64.pi2);
            fixmath.SinCos(angle, out var sin, out var cos);
