    ...
    public class plotting
    {
        ...
        public void Atan_Plottting()
        {
            ...
            foreach (var tan in tans)
            {
                ...
                var aprox1Tan = fixmath.Atan(Fix64.ParseUnsafe((float)tan)).AsDouble;
                approxValue1.Add(aprox1Tan);
                approxValueError1.Add(correctTan - aprox1Tan);
                var aprox2Tan = fixmath.AtanApproximated(Fix64.ParseUnsafe((float)tan)).AsDouble;
        ...
        public void Atan2_Plottting()
        {
            ...
            foreach (var tan in xValues)
            {
                ...
                correctValue.Add(correctTan);
                var aprox1Tan = fixmath.Atan2(Fix64.ParseUnsafe((float)tan), Fix64._1).AsDouble;
                approxValue1.Add(aprox1Tan);
                approxValueError1.Add(correctTan - aprox1Tan);
            }
